...
def video_model_load_stage_dict_from_image(ckpt, video_model):
    ...
    video_model.load_state_dict(para_dict)
...
def main(args):
    ...
    if rank == 0:
        ...
        experiment_dir = f"{args.results_dir}/{experiment_index:03d}-{model_string_name}-video"  # Create an experiment folder
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, choices=list(models.VideoDiT_models.keys()), default="FA-B/4")
